# bot.py - HAGU BOT - Complete Version 1.5.1 (Gemini Corrected & Optimized)
import logging
import random
import time
import re
...
##### GEMINI INTEGRATION START (CORRECTED) #####
...
GEMINI_API_KEY = "AIzaSyCOyPQ1a6eO0N_Fboz_msazG9qC9phufo0" # আপনার Gemini API Key এখানে বসান
##### GEMINI INTEGRATION END #####
...
##### GEMINI MODEL INITIALIZATION (CORRECTED) #####
try:
    ...
    gemini_model = None
##### GEMINI MODEL INITIALIZATION END #####
...
##### GEMINI INTEGRATION START (CORRECTED FUNCTION) #####
async def ask_gemini_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        # Run the blocking API call in a separate thread to avoid freezing the bot
